...
<tr class="board-swimlane-columns-<?= $swimlane['id'] ?>">
    ...
    <th class="board-column-header board-column-header-<?= $column['id'] ?>" data-column-id="<?= $column['id'] ?>">
        ...
        <div class="board-column-expanded">
            <?php if (! $not_editable): ?>
                <div class="board-add-icon popover">			
			<?= $this->url->link('+', 'taskcreation', 'create', array('project_id' => $column['project_id'], 'column_id' => $column['id'], 'swimlane_id' => $swimlane['id']), false, '', t('Add a new task')) ?>
                </div>
            <?php endif ?>
