<?php if (! $ajax): ?>
<div class="btn-group">
    <a href="/kanboard/board/<?= $values['project_id'] ?>" class="btn btn-info">
        <i class="fa fa-th fa-fw"></i>&nbsp;<?= t('Back to the board') ?>
    </a>
</div>
<p></p>
<?php endif ?>
...
<div class="panel-body">
   <form id="task-form" role="form" method="post" action="<?= $this->url->href('taskcreation', 'save', array('project_id' => $values['project_id'])) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
    ...
    <div class="form-actions">
        <button type="submit" value="<?= t('Save') ?>" class="btn btn-primary" tabindex="11">Create</button>
